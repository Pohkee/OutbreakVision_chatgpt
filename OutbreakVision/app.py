...
def get_country_data():
    ...
    prompt = f"""Using your training data and best available knowledge (up to 2023), estimate the following statistics for {country}. Please respond ONLY with a JSON object in this format:
...
{{
  ...
  "health_access": number,
  "travel_tourism": number,
  "pollution": number
}}

If you need to explain anything, do it AFTER the JSON block.
"""
    ...
    try:
        ...
        print("✅ Parsed JSON:", stats)

        return jsonify(stats)

    except  Exception as e:
        print("Error in /country-data:", e)
...
def mergeCombined_GlobalCovid():
    ...
    try:
        ...
        # combined_df = pd.read_csv('C:\Users\karee\.vscode\OutbreakVision\OutbreakVision\combined_country_data.csv')
